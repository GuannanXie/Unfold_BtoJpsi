...
void unfold_decay()
{
    ...
    TH1D* gPhenixB=(TH1D*)fin->Get("gYieldB_phenix"); //Phenix group unfold B result

    TFile *fsim = new TFile("rootfiles/BtoAll.phenix.hist.root");
    ...
    leg6->AddEntry(unfoldedBtoAll,"Unfolded B pT","l");
    leg6->AddEntry(gPhenixB,"Unfolded B pT (phenix group)","l");
