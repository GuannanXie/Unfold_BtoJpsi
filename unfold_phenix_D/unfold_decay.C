...
void unfold_decay()
{
    ...
    TH1D* dataDtoe=(TH1D*)fin->Get("gCountsCtoe_phenix"); //Side product: Btoe pt:
    
    dataDtoe->Scale(0.7);
    
    TH1D* gPhenixD=(TH1D*)fin->Get("gYieldC_phenix"); //Phenix group unfold B result

    TFile *fsim = new TFile("rootfiles/DtoAll.phenix.hist.root");
